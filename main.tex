...
\twocolumn[
  ...
  \PaperSummary{%
    ここには，研究の要点を150字程度にまとめて記載して下さい．この幅で入力すると1行で約50文字になりますので，150字では，約3行になります．この様式は岡沼教授の作成したWordファイルを基に，\LaTeX{}用に一部修正を加えました．研究室毎に，必要に応じて改変して利用して下さい．%
  }
]
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{./figures/diagram.jpg}
